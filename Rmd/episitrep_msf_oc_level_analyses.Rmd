...
tble5_bis <- dta_linelist %>%
  ...
  summarise(
    ...
    n_icu_later  = sum(merge_admit == "Yes" & icu == "No" & merge_icu == "Yes", na.rm = TRUE),
...
gtsave(gtble5_bis, 
       file.path(path.local.msf.tables.oc, paste0('gtble5_bis', '_', week_report, '.html')), 
       inline_css = TRUE) %>% 
  invisible()
...
tble6 <- dta_linelist %>%
  ...
  summarise(
    ...
    n_oxygen_later  = sum(merge_admit == "Yes" & received_oxygen == "No" & merge_oxygen == "Yes", na.rm = TRUE),
...
tble7 <- dta_linelist %>%
  ...
  summarise(
    ...
    n_probable_oxygen_later  = sum(covid_status == "Probable" & merge_admit == "Yes" & received_oxygen == "No" & merge_oxygen == "Yes", na.rm = TRUE),
    ...
    n_suspected_oxygen_later  = sum(covid_status == "Suspected" & merge_admit == "Yes" & received_oxygen == "No" & merge_oxygen == "Yes", na.rm = TRUE),
    ...
    n_confirmed_oxygen_later  = sum(covid_status == "Confirmed" & merge_admit == "Yes" & received_oxygen == "No" & merge_oxygen == "Yes", na.rm = TRUE),
...
tble9_bis <- dta_linelist %>%
  ...
  summarise(
    ...
    n_vent_later  = sum(merge_admit == "Yes" & vent == "No" & merge_vent == "Yes", na.rm = TRUE),
...
gtble9_bis <-  tble9_bis %>% 
  ...
  cols_label(
    ...
    m_vent_admission = 'Oxygen at adm.',
    m_vent_later     = 'Oxygen later',
    ) %>% 
...
gtsave(gtble9_bis, 
       file.path(path.local.msf.tables.oc, paste0('gtble9_bis', '_', week_report, '.html')), 
       inline_css = TRUE) %>% 
  invisible()
...
tble9 <- dta_linelist %>%
  ...
  summarise(
    ...
    n_probable_vent_later  = sum(covid_status == "Probable" & merge_admit == "Yes" & vent == "No" & merge_vent == "Yes", na.rm = TRUE),
    ...
    n_suspected_vent_later  = sum(covid_status == "Suspected" & merge_admit == "Yes" & vent == "No" & merge_vent == "Yes", na.rm = TRUE),
    ...
    n_confirmed_vent_later  = sum(covid_status == "Confirmed" & merge_admit == "Yes" & vent == "No" & merge_vent == "Yes", na.rm = TRUE),
