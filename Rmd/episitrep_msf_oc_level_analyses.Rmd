...
path.local.msf.data.oc   <<- file.path(path.local.week.oc, OC, 'data')
path.local.msf.graphs.oc <<- file.path(path.local.week.oc, OC, 'graphs')
path.local.msf.tables.oc <<- file.path(path.local.week.oc, OC, 'tables')
...
ggsave(file.path(path.local.msf.graphs.oc, paste0('hist_epicurve_status', '_', week_report, '.png')),
