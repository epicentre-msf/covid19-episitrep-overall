...
## Figure 1 – Weekly evolution of the total number of patients by covid19 status and by project
...
plot_epicurve_project <- function(data, 
  ...
  ggsave(filename = paste0(project, '_', 'hist_epicurve_status', '_', week_report, '.png'),
         path = path.local.msf.graphs.oc,
         plot = fig_data, 
         width = 6,
         height = 4,
