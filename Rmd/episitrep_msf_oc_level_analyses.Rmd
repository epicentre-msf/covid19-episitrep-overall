...
## Table 2 – Number of patient visits and hospitalisation by project and severity (includes confirmed, suspect, probable cases only)

Table 3 – Median length of stay according to severity
...
## Table 4 – Median age stratified by gender, project and hospitalisation status
...
### UNFINISHED? THEY ADDED MORE LEVELS ###
