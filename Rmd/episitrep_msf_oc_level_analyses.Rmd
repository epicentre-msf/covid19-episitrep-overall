...
tble1 <- dta_linelist %>%
  ...
  summarise(n_patients           = n(),
            ...
            n_admited_post       = sum(outcome_admit == "Yes", na.rm = TRUE),
...
gtble1 <- tble1 %>% 
  ...
  tab_spanner(
    label = 'Hospitalised during course',
...
gtble2 <- tble2 %>% 
  ...
  summary_rows(
    columns = vars(n_patients, n_mild, n_moderate, n_critical),
    fns = list(Total = "sum"),
    decimals = 0)
