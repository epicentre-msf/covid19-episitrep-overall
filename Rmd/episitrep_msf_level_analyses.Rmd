...
# Set the left and right censoring date terms. 
# The right-censoring create also the week and the folders where to save the outputs
dates_and_week <- set_date_frame(date_min = '2020-06-01', date_max = '2020-08-30', week_suffix = 'june-august')
...
# Set the left censoring date (if NULL non left-censoring is made)
