...
# MSF activity by country
```{r tbl_country_covid_status}
...
gtsave(gtbl_countries_covid_status, 
       file.path(path.local.msf.tables, glue("gtbl_countries_covid_status_{week_report}.html"))) %>% 
  invisible()

gtsave(gtbl_countries_covid_status, 
       file.path(path.local.msf.tables, glue("gtbl_countries_covid_status_{week_report}.png"))) %>% 
  invisible()
...
gtsave(gtbl_deaths, 
       file.path(path.local.msf.tables, glue("gtbl_risk_outcome2_{week_report}.html")), 
       inline_css = TRUE) %>% 
  invisible()

gtsave(gtbl_deaths, 
       file.path(path.local.msf.tables, glue("gtbl_risk_outcome2_{week_report}.png"))) %>% 
  invisible()
