...
# Set the right censoring date terms. This create also the folders where to save the outputs
date_and_week_max <- set_date_max()

date_max_report <- date_and_week_max[[1]]
week_report     <- date_and_week_max[[2]]


# Set the left censoring date (if NULL non left-censoring is made)
date_min_report <- NULL
