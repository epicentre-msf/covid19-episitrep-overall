...
for(i in names(lst_dta_jhu)){
  mdl <- linear_trend(dta = lst_dta_jhu[[i]], series = 'cases', n_days = 12, last_date = date_max)
...
for(i in names(lst_dta_jhu)){
  mdl <- linear_trend(dta = lst_dta_jhu[[i]], series = 'deaths', n_days = 12, last_date = date_max)
...
for(i in names(lst_dta_jhu)){
  mdl <- linear_trend(dta = lst_dta_jhu[[i]], series = 'cases', n_days = 30, last_date = date_max)
...
for(i in names(lst_dta_jhu)){
  mdl <- linear_trend(dta = lst_dta_jhu[[i]], series = 'deaths', n_days = 30, last_date = date_max)
