...
# CAS
p <- geofacet_plot(df_data_africa, 
                   "cases", 
                   continent = "Africa", 
                   my_grid = "africa_countries_grid1",
                    scales = "free_y",
                   angle = 90)
ggsave(file.path(path.local.deepdive.Africa,
                 paste0('geofacet_cases_free_y', '_', 
                        week_report, '.png')),
       width = 14, 
       height = 12)
...
p <- geofacet_plot(df_data_africa, 
                   ...
                   angle = 90)
ggsave(file.path(path.local.deepdive.Africa,
                 paste0('geofacet_deaths_free_y', '_', 
                        week_report, '.png')),
       width = 14, 
       height = 12)
...
p <- geofacet_plot(df_data_africa, 
                   ...
                   angle = 90)
ggsave(file.path(path.local.deepdive.Africa,
                 paste0('geofacet_deaths_fixed', '_', 
                        week_report, '.png')),
       width = 14, 
       height = 12)
...
p <- geofacet_plot(df_data_africa, 
                   ...
                   angle = 90)
ggsave(file.path(path.local.deepdive.Africa,
                 paste0('geofacet_cases_per_100000_free_y', '_', 
                        week_report, '.png')),
       width = 14, 
       height = 12)
...
p <- geofacet_plot(df_data_africa, 
                   ...
                   angle = 90)
ggsave(file.path(path.local.deepdive.Africa,
                 paste0('geofacet_cases_per_100000_fixed', '_', 
                        week_report, '.png')),
       width = 14, 
       height = 12)
...
p <- geofacet_plot(df_data_africa, 
                   ...
                   angle = 90)
ggsave(file.path(path.local.deepdive.Africa,
                 paste0('geofacet_deaths_per_million_free_y', '_', 
                        week_report, '.png')),
       width = 14, 
       height = 12)
...
p <- geofacet_plot(df_data_africa, 
                   ...
                   angle = 90)
ggsave(file.path(path.local.deepdive.Africa,
                 paste0('geofacet_deaths_per_million_fixed', '_', 
                        week_report, '.png')),
       width = 14, 
       height = 12)
