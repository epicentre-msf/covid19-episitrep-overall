...
tbl_countries_increasing_cases <- tbl_case_trend %>% 
  ...
  select(continent, country, cases, cases_30d, cases_14d, trend_cases_30d, trend_cases_14d)
...
tbl_countries_increasing_deaths <- tbl_death_trend %>% 
  ...
  select(continent, country, deaths, deaths_30d, deaths_14d, trend_deaths_30d, trend_deaths_14d)
