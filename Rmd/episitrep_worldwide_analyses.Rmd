...
if(dir.exists(here(path.local.week.deepdive, "Africa"))) {
  ...
  for (i in continent_list) {
    ...
    if(file.exists(here(path.local.week.deepdive, i, glue::glue("map_cases_trends_{week_report}.png")))) {
      
      cat('\n')
      cat('\n##', i, '\n')
      
      path_i <- here(path.local.week.deepdive, i, glue::glue("map_cases_trends_{week_report}.png"))
