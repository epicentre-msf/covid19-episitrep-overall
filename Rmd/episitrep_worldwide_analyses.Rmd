...
#dta_jhu <- covidutils::get_ecdc_data() %>% 
#  prepare_ecdc_data()
...
This document uses the following data sources: 
  ...
  - [ECDC data](https://opendata.ecdc.europa.eu/covid19/casedistribution/csv) last updated `r format(max(dta_jhu$date, na.rm = TRUE), "%d %b %Y")`.   
