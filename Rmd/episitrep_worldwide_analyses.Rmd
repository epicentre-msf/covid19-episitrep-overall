...
gtbl_countries_increasing_cases <- tbl_countries_increasing_cases %>% 
  ...
  tab_style(
    style = list(
      cell_fill(color = palette_RdAmGn[1], alpha = 0.8), 
  ...
  tab_style(
    style = list(
      cell_fill(color = palette_RdAmGn[2], alpha = 0.8)), 
    locations = cells_body(
      columns = vars(coeff, coeff_ci), 
      rows = trend == 'Stable')) %>% 
  tab_style(
    style = list(
      cell_fill(color = palette_RdAmGn[3], alpha = 0.8)), 
    locations = cells_body(
      columns = vars(coeff, coeff_ci), 
...
gtbl_countries_increasing_deaths %>% 
  tab_header(
    title = 'Countries with a significant increasing trend in deaths in cases in the last 30 or 14 days')
