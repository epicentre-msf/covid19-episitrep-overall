...
author: Francesco Grandesso (Epicentre)
...
The cumulative number of cases are mapped in Figure \@ref(fig:map-world-cases-incidence-proportion). The cumulative number of deaths are mapped in Figure \@ref(fig:map-world-deaths-incidence-proportion). 
...
dotsgplot_inc <- function(tbl_inc = tbl_inc_cml, name_continent){
  ...
  dotsgplot <- ggplot(temp_tbl) + 
    ...
    labs(
      ...
      y = "Incidence proportion of cases in the last 30 days per 100,000 population",
