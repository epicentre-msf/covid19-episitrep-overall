...
**Table Outcome 1 - Count outcome count of cured, deaths, transferred… by country?? (Probably by continent)** 

```{r}
# TO BE DONE by Francesco. Priority +++
```
