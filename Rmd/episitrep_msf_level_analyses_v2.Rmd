...
ggsave(file.path(path.local.msf.graphs, paste0('msf', 'pyramid_age_sex_all_continent', week_report, '.png')),
...
ggsave(file.path(path.local.msf.graphs, paste0('msf', 'pyramid_age_sex_confirmed', '_', week_report, '.png')),
...
ggsave(file.path(path.local.msf.graphs, paste0('msf', 'pyramid_age_sex_confirmed_continent', '_', week_report, '.png')),
