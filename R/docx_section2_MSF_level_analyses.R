...
my_doc <- add_par_normal(
  sprintf("Table 2 describes the levels of severity found in patients consulted/admitted in MSF facilities, according to their covid19 status. Though there was a lot of missing data for this variable, overall XXX of all patients (XXX of confirmed) received were assessed to be in a severe or critical state."))
